...
public class UiConnector
{
    ...
    public int registerOfficer(String area, String name, String password, String phone, String cnic, String department)  {
        if(!db.Register(cnic))
            return 0;
        registerUser = new Officer(area, name, password, phone, cnic, department);
        //store in db
