...
public class BLConnector {
  ...
  public int RegisterOfficer(
      String area, String name, String password, String phone, String cnic, String department) {
    return connector.registerOfficer(area, name, password, phone, cnic, department);
  }
